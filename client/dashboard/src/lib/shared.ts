export const appName = 'MotionMesh';
export const appUrl = 'https://motionmesh.co.in';
export const apiUrl = 'https://api.motionmesh.co.in';
...
export const socialLinks = {
  discord: 'https://discord.gg/motionmesh',
